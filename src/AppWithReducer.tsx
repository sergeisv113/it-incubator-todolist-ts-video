...
let todolistId2 = v1()
    ...
    let [todolists, dispatchTodolistsReducier] = useReducer(todolistsReducer, [
        {id: todolistId1, title: "What to buy", filter: 'all'},
        {id: todolistId2, title: "What to learn" , filter: 'all'}
    ]);

    let [tasks, dispatchTasksReducier] = useReducer(tasksReducer, {
        [todolistId1]: [
...
*/
    ...
    function changeFilter(todolistId: string, value: FilterValuesType, ) {
        ...
        dispatchTodolistsReducier(action)
